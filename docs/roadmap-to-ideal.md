# QAZ.INDUSTRIES — исторический план доведения до целевого состояния
...
Дата исторической фиксации: 2026-08-09.

Этот документ сохраняет план, receipts и ограничения прежнего среза. Он не
является источником текущего release status. Актуальные identity, runtime и
public evidence находятся в [`current-release.md`](current-release.md), а
полный индекс — в [`index.md`](index.md).

## 1. Историческая базовая точка
...
Исторический проверенный commit: d833ef5fdcd024e80eca6b4e9cc2275bab231d21.

Исторический публичный release: 20260809T103218Z-d833ef5fdcd0.
...
- AV DS 4 tokens, components и композиции потреблялись на всех трёх страницах;
...
4. В историческом срезе resolver ещё не индексировал имя QAZ.INDUSTRIES. Сейчас
   проект находится через resolver; соседние проекты по-прежнему менять нельзя.
