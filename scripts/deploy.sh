...
for asset in index.html industry.html benchmarks.html styles.css avds-tokens.css avds.css runtime.js site-shell.js snapshot-contracts.js qazgeo-geometry.js profile-view.js app.js qazgeo-map.js industry-data.js industry.js favicon.svg release.json; do
