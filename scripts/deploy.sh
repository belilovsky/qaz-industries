...
for asset in index.html industry.html benchmarks.html styles.css avds.css app.js qazgeo-map.js industry-data.js industry.js favicon.svg release.json; do
