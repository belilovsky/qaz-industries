window.QAZ_INDUSTRIES = {
  energy: {
    ...
    release: 'Публичный срез · август 2026',
    ...
    kpis: [
      { value: '150', label: 'показателей', period: 'публичный реестр' },
      { value: '18', label: 'объектов', period: 'карта и паспорта' },
      { value: '9', label: 'материалов', period: 'редакционный выпуск' },
      { value: '18', label: 'регионов', period: 'географический охват' }
    ],
    indicators: [
  ...
  space: {
    ...
    kpis: [
      { value: '31', label: 'объект и система', period: 'публичный атлас' },
      { value: '134', label: 'проверенных факта', period: 'корпус выпуска' },
      { value: '20', label: 'материалов', period: 'редакционная лента' },
      { value: '106', label: 'источников', period: 'реестр доказательств' }
    ],
    indicators: [
      { name: 'Объекты и системы', value: '31', unit: 'ед.', period: 'выпуск 2026-07-26.29', note: 'Инфраструктура и программы', url: 'https://qazaqstan.space/infrastructure' },
      { name: 'Проверяемые утверждения', value: '134', unit: 'факта', period: 'выпуск 2026-07-26.29', note: 'С типом, статусом и границей вывода', url: 'https://qazaqstan.space/data' },
      { name: 'Редакционные сигналы', value: '20', unit: 'сигналов', period: 'выпуск 2026-07-26.29', note: 'Датированные отраслевые события', url: 'https://qazaqstan.space/media' },
      { name: 'Проверенные источники', value: '106', unit: 'источников', period: '26 июля 2026', note: 'Государственные, официальные и исследовательские', url: 'https://qazaqstan.space/register' }
    ],
    chain: [
  ...
  farm: {
    ...
    release: 'Выпуск 2026-07-27.1 · данные на 20 июля',
    ...
    kpis: [
      ...
      { value: '15', label: 'источников', period: 'проверенный выпуск' }
    ],
    indicators: [
  ...
  water: {
    ...
    release: 'Публичный срез · 1 августа 2026',
